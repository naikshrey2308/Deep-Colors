<?php
    ...
    if(!isset($_POST["id"]) && !isset($_POST["gen_bill"])) {
        ...
        <h2 style="font-size: 40px;">Billing Area</h2>
            <form style="width: 100%;" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="register">
                <table style="width: 100%; margin-left: 0px;">
                    ...
                    <tr>
                        <td><input type="hidden" name="quantity" value="<?php echo $_POST["quantity"]; ?>"></td>
                        <td><input type="hidden" name="id" value="<?php echo $_POST["id"]; ?>"></td>
                        <td><input type="hidden" name="size" value="<?php echo $size; ?>"></td>
                    </tr>
                    <tr><td><br></td></tr>
                    <tr>
                ...
                <?php
                    ...
                    if($result = mysqli_query($conn, $sql)) {
                        ...
                        <tr>
                            ...
                            <td style="border: 2px solid cornflowerblue; border-collapse: collapse;"><?php echo $_POST["quantity"]." ($size)"; ?></td>
                ...
                <?php
                    ...
                    if($result = mysqli_query($conn, $sql)) {
                        ...
                        <tr>
                            <td style="border: 2px solid cornflowerblue; border-collapse: collapse;"><?php echo $row["Name"]; ?></td>
                            <td style="border: 2px solid cornflowerblue; border-collapse: collapse;"><?php echo $_POST["quantity"]."($size)"; ?></td>
                            <td style="border: 2px solid cornflowerblue; border-collapse: collapse;"><?php echo $row["Price"]; ?></td><?php $total *= $row["Price"]; ?>
                            <td style="border: 2px solid cornflowerblue; border-collapse: collapse;"><?php echo $total; ?></td>
                        </tr>
                        <?php
                    }
                ?>
